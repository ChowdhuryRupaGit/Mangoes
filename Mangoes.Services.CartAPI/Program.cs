...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddHttpClient("Coupon", u => u.BaseAddress = new Uri(builder.Configuration["ServiceUrls:CouponBaseUrl"])).AddHttpMessageHandler<BackendApiDelegatingHandler>();
